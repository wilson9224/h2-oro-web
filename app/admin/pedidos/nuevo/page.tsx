...
function NewCatalogSalePage() {
  ...
  return (
    <div className="max-w-full space-y-4 font-sans-custom sm:max-w-2xl">
      ...
      <div>
        <h1 className="text-2xl font-semibold text-cream-100">Venta presencial</h1>
        <p className="text-sm text-charcoal-400 mt-1">Registro de venta de joya del catálogo</p>
      </div>
            ...
            {selectedProduct ? (
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2.5 bg-charcoal-900 border border-white/5 rounded-md text-sm text-cream-200 placeholder:text-charcoal-500 focus:outline-none focus:border-gold-500/30"
                />
                {isSearchingProduct && (
                  <Loader2 size={14} className="absolute right-3 top-1/2 -translate-y-1/2 text-charcoal-500 animate-spin" />
                )}
                {productResults.length > 0 && (
                  <div className="absolute z-20 mt-1 w-full bg-charcoal-900 border border-white/10 rounded-md shadow-xl overflow-hidden">
              ...
              {showNewClientForm && (
                <div className="bg-gold-500/5 border border-gold-500/20 rounded-md p-3 space-y-2">
                  ...
                  <input type="email" placeholder="Email (opcional)" value={newClient.email}
                    ...
                    className="w-full px-2 py-1.5 bg-charcoal-900 border border-white/5 rounded text-xs text-cream-200 placeholder:text-charcoal-500" />
                </div>
              )}
            </div>
          </div>
        ...
        <SectionCard>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="number" min="0" step="1000" value={finalPriceCop}
                  ...
                  placeholder="0"
                  className="w-full pl-7 pr-3 py-2.5 bg-charcoal-900 border border-white/5 rounded-md text-sm text-cream-200 placeholder:text-charcoal-500 focus:outline-none focus:border-gold-500/30" />
              </div>
          ...
          <div className="mt-4">
            ...
            <textarea value={notes} onChange={(e) => setNotes(e.target.value)} rows={2}
              ...
              className="w-full px-3 py-2.5 bg-charcoal-900 border border-white/5 rounded-md text-sm text-cream-200 placeholder:text-charcoal-500 focus:outline-none focus:border-gold-500/30 resize-none" />
          </div>
        </SectionCard>
